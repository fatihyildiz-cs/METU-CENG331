...
#### MODIFICATIONS THAT ARE DONE BY ME ####
# I implemented "iaddq" instruction in here as I did in Part B
# The reason for such an addition is, processor is able to make faster
# computations with constants rather than registers, thus I implemented
# and used it in increment operations in ncopy.ys
# For implementation of "iaddq", I inserted "IIADDQ" to the following parts:
##	Fetch stage: instr_valid, need_regids, need_valC 
##	Decode stage: d_srcB=D_rB, d_dstE=D_rB (To connect destination and source)
##	Execute stage: aluA=E_valA, aluB=E_valB, set_CC 
